...
# 【       Subject : 22'. 02. 07. matplotlib 적용  시각화!~       】
...
model.compile(loss='categorical_crossentropy', optimizer=optimizer, metrics=['acc'] )               # loss는 categorical_crossentropy가 된다.+ 모든분류에서 accuracy가 가능하다(보조지표 metrics)
# Fit
...
# ㅎㅎㅎㅎㅎ metrics에서 accuracy라고 써줬는데 밑에서 acc라고 해서 안되는거였음
#########################################################################################################
# lerning rate :  0.01
# loss :  0.1349
# acc :  0.969
