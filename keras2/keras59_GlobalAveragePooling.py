...
# Flatten 대신 GlobalAveragePooling 가능
...
# Flatten을 삭제한 후 GlobalAveragePooling을 사용한다.
# 평균치를 내어 10개의 output에 뿌려준다.
# 찾아서 정리 ㄱ
######################################################################################################################################################
...
# model.add(Flatten())                  # flatten대신 GlobalAveragePooling사용
