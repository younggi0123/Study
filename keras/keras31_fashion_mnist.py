...
#수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정수정
...
model.fit(x_train, y_train, epochs=20, batch_size=1, verbose=1,    #표본이 50만개인데 설마 배치사이즈1을 하진 않겠죠???
