...
x_train = np.concatenate((x_train, x_augmented))  # 결과 : (100000, 28, 28, 1)
...
if os.path.exists(path):
    ...
    # #fit
    # model.fit_generator( x_train,y_train, epochs=10, steps_per_epoch=len(xy_train),
    ...
    model.save("./_save/keras50_1_flow.h5")
...
print('loss : ', loss)
# Predict
# predict가 y_test가 아니고 x_Test였음 이것도 다시 찾아보기
...
# loss :  [0.30892398953437805, 0.9211000204086304]
