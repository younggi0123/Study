...
from tensorflow.keras.models import Sequential, Model, load_model #load_model 추가!
...
start = time.time()
# History <- Fit
hist = model.fit(x_train, y_train, epochs=10, batch_size=1, validation_split=0.2, verbose=1)
end = time.time() - start
