...
filename = '{epoch:04d}-{val_loss:.4f}.hdf5' # 2500-0.3724.hdf5 (하단 hist에서 반환한 값이 그대로 저장된다. hist아닌 hist.history)
                                             # 4자리까지 빼겠다
model_path = "".join( [ filepath, 'keras27.5_', hello, '_',filename ] )    # join함수 -> 시간, 파일경로, 파일이름
...
model.save('./_Save/keras27.5_save_wine.h5')
...
model2 = load_model('./_Save/keras27.5_save_wine.h5')
