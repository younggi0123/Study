...
hist = model.fit_generator(train_generator, epochs=5, steps_per_epoch=train_generator.samples//90,
                           validation_data= validation_generator,
                           validation_steps= validation_generator.samples//90,
                           # verbose = 1
                           )
...
scores = model.evaluate_generator(validation_generator, test_generator) #, steps=5????
