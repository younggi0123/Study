...
import os
path = "./_save/horse_or_human_IDG_1.h5"
if os.path.exists(path):
  ...
  #model = load_model(path)  
    ...
    model.save("./_save/horse_or_human_IDG_1.h5")
...
print("Between horse and human Accuracy : ",str(np.round(acc ,2)*100)+ "%")# 여기서 accuracy는 이 밑의 샘플데이터에 대한 관측치가 아니고 모델 내에서 가위,바위,보를 학습하고 평가한 정확도임
...
# Between horse and human Accuracy :  51.0%
# 49.67 %의 확률로
#  → '말'입니다.ㅠㅠ
