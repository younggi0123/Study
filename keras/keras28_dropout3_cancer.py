...
# model2 = load_model('./_Save/keras28.3_save_cancer.h5')
...
# 1. 드랍아웃 미적용 : loss :  [0.34470435976982117, 0.8888888955116272]

# 2. 드랍아웃 적용 :  loss :  [0.24344804883003235, 0.9064327478408813]
