...
# 파라미터 조합으로 2개이상 엮을 것
# 2.  모델구성
# model =GridSearchCV( RandomForestClassifier(), parameters1, cv=kfold , verbose=1, refit=True, n_jobs= -1 )
...
# Model Score :  0.8385269121813032
# Accuracy Score :  0.8385269121813032
# Best Tuned ACC :  0.8385269121813032
# =============================================================
# 걸린시간 :  6.13 초