...
print("엑스트레인",x_train,"엑스테스트",x_test)
print("와이트레인",y_train,"와이테스트",y_test)
...
pipe = Pipeline( [("ss", StandardScaler()), ("rf",RandomForestClassifier())] ) # Pipeline사용법 : 1. 리스트씌우기 2.이름을 명시
...
# 걸린시간 :  17.93759322166443
# model.score :  0.9348441926345609
