...
print(x_data.shape, y_data.shape) #(178, 13) (178,)                 # 13
...
encoder.fit(y_data)
y_data = encoder.transform(y_data).toarray()                # 하.. toarray!!!!!!!!!!!!!!toarray!!!!!!!!!!!!!!toarray!!!!!!!!!!!!!!
...
w1 = tf.Variable(tf.zeros([13,20]),name='weight1')
